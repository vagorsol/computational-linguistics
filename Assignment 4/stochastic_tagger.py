...
print("\nBigram Default Tagger:")
print(biTagr.tag(cs_words))
print("\nBigram RE Tagger:")
print(biREtagr.tag(cs_words))
print("\nRE Tagger:")
print(reTagr.tag(cs_words))
print("\nHidden Markov Model Tagger:")
print(hmmTagr.tag(cs_words))
print("\nNTLK's Tagger: ")
print(nltk.pos_tag(cs_words, tagset="universal"))
...
print("\nBigram RE Tagger:")
print(biREtagr.tag(animals_words))
print("\nRE Tagger:")
print(reTagr.tag(animals_words))
print("\nHidden Markov Model Tagger:")
print(hmmTagr.tag(animals_words))
print("\nNTLK's Tagger: ")
print(nltk.pos_tag(animals_words, tagset="universal"))